function Get-TargetResource
{
    ...
    $Version = (Get-WmiObject -Class Win32_Product | Where-Object {$_.Name -like "System Center Operations Manager * Web Console"}).Version
...
function Set-TargetResource
{
    ...
    switch($Version)
    {
        ...
        "7.2.11759.0"
        {
            # Add the correct UR1 filename for 2016
